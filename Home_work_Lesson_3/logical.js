...
function accessByAge() {
    let age = 90
    if ( age <= 1 && age > 0) { console.log ("Baby");}
        else if ( age <= 12 && age > 1) { console.log ("Child");}
        else if ( age <= 19 && age > 13) { console.log ("Teenager");}
        else if ( age <= 21 && age > 19) { console.log ("Juvenile");}
        else if ( age <= 45 && age > 21) { console.log ("Young age");}
        else if ( age <= 60 && age > 45) { console.log ("Middle age");}
        else if ( age <= 75 && age > 60) { console.log ("Old age");}
        else if ( age >= 75) { console.log ("Long_lived age");}
    }
    // Logical "||" operation
